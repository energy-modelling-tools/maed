  ...
  <div class="container-lg p-responsive py-4 py-md-6 ">
    <div class="col-md-12 animate-out mb-2">
      ...
      <p class="alt-lead text-gray text-justify-between col-md-15 mx-auto">
        <strong>The Model for the Analysis of Energy Demand (MAED)</strong> was developed by the International Atomic Energy Agency (IAEA) and evaluates future energy demands (final and useful) based on medium to long term scenarios of socioeconomic, technological, and demographic development. Energy demand is disaggregated into a large number of end-use categories corresponding to different goods and services. MAED can be configured to reflect the economic structure of the sub-national or national case study in question and is designed to simulate demand in the medium and long term for developing economies. We would like to test the EDIT issue.
      </p>
      <!-- /CMS:section -->
    </div>
    ...
    <div class="col-md-12 animate-out mb-2">
      ...
      <p class="alt-lead text-gray text-justify-between col-md-15 mx-auto">
        MAED’s source code can be found on GitHub open source [here](MAED’s source code can be found on GitHub open source here. Any contributions from the community are welcome. ). Any contributions from the community are welcome.
      </p>
      <!-- /CMS:section -->
    </div> 
  </div>
